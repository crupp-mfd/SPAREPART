...
SELECT
    ...
    P."WG_REGIST_LAND",
    TRY(CAST(P."WG_INBETRIEBNAHME" AS DATE)) AS "WG_INBETRIEBNAHME",
    P."WG_ZUL_GES_GEWI",
    ...
    P."WG_ZULASSSTELLE",
    TRY(CAST(P."WG_ZULASSDATUM" AS DATE)) AS "WG_ZULASSDATUM",
    P."WG_ZULASSREFNR",
    TRY(CAST(P."WG_ZULASSENDDAT" AS DATE)) AS "WG_ZULASSENDDAT",
    P."WG_ZULAUSGESETZ",
    TRY(CAST(P."WG_ZULAUSDATUM" AS DATE)) AS "WG_ZULAUSDATUM",
    P."WG_ECVERSTELLE",
    TRY(CAST(P."WG_ECVERDATUM" AS DATE)) AS "WG_ECVERDATUM",
    P."WG_ECVERNR",
    P."WG_ERATVREF",
    P."WG_TSI_ZUS_ZERT",
    P."WG_ECMWECHSNEXT",
    TRY(CAST(P."WG_ECMWECHSDAT" AS DATE)) AS "WG_ECMWECHSDAT",
    P."WG_HALTER_VORHE",
    P."WG_AUSSERBETRIE",
    P."WG_AVVWAGEN",
